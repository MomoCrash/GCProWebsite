        ...
        <div class="animated-on-scroll">
            <div class="intro_container" id="intro">
                ...
                <div class="texte_intro">
                    ...
                    <div class="alaide">
                        <p> The Sense est né d’un projet d’école de quatre étudiants en école de commerce. Se basant sur
                            une idée originaire des États-Unis, les quatre amis décidèrent d’adapter ce concept inédit
                            au marché français en y ajoutant leurs idées novatrices. Mélant deux activités attractives,
                            la Réalité Virtuel et les Escape Game, THE SENSE joint le meilleur des deux mondes pour vous
                            proposer des expériences inédites et époustouflantes. N’hésitez plus et franchisser la
                            frontière du réel.
                        </p>
                    </div>
                    ...
                    <div class="container">
                        <div class="iframe-container">
                            <iframe id="iframegoogle"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2783.501839966723!2d4.846184576846494!3d45.76113207108033!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47f4ea5e4b5e0f67%3A0xed466e201cea076d!2s207%20Rue%20Duguesclin%2C%2069003%20Lyon!5e0!3m2!1sfr!2sfr!4v1706879039820!5m2!1sfr!2sfr"
        ...
        <div class="container">
            <div class="contact-container">
                ...
                <form action="Apropos.php" method="post">
                    ...
                    <input class="inputcontact" id="prenom" name="prenom" size="27" type="text" placeholder="Prenom" />
                    <br> <br>
                    <input class="inputcontact" id="mail" name="mail" size="27" type="text" placeholder="Mail" /> <br>
                    <br>
