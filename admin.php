    ...
    <main>
        <div class="animated-on-scroll">
            <div class="admin-container">
                ...
                <form method="post" action="addArticle.php" id="create-article-form" enctype="multipart/form-data">
        ...
        <div class="animated-on-scroll">
            <div class="article">
                <form id="delete-article-form" method="post" action="supprimerArticle.php">
                    <div class="form-group">
                    ...
                    <button type="submit" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet article ?');">Supprimer l'article</button>
                </form>
            </div>
        </div>
        <div class="animated-on-scroll">
