...
<body class="fond_template">
    ...
    <header></header>
    <div class="loginbg">
        <form action="../account.php?method=login&redirect=../battleroom/batlle_room1.php" method="POST"
    ...
    <div class="intro_exp">
        ...
        <div class="img_exp">
            ...
            <img class="img_behind" src="../ressources/image 47sdffsdsfdsfdsdsdfsdfdsfdsdfhsdfhsdds.jpg"
                alt="image de l'experience" />
            <!--image du fond-->
            <!--NB DE LIKES-->
            <div class="likes">
        ...
        <div class="about_exp_battleroom">
            ...
            <!--TXT A PROPOS-->
            <div class="about_txt">
                <p>Sentez votre cœur battre, votre souffle se couper, votre concentration monter... Enrôlez des joueurs,
                    formez votre équipe et
                    préparez vous au combat ! Arrachez la victoire à vos adversaires à travers une bataille dans des
                    décors et des "maps" des
                    plus immersives. En équipe de 4 ou 5 voyez lesquels d’entre vous seront dignes de remporter le
                    trophée.</p>
            </div>
        ...
        <div class="img_exp">
            ...
            <img class="img_behind" src="../ressources/image 64.png" alt="image de l'experience" />
            <!--image du fond-->
        ...
        <div class="about_exp_battleroom">
            ...
            <!--TXT A PROPOS-->
            <div class="about_txt">
                <p>Partez au front, avec vos amis ou votre famille, découvrez un univers certes plus cartoonesque mais
                    ne vous y méprenez pas, vos ennemies vous attendent. Vous avez pour objectifs de remporter les
                    batailles ! Munissez vous de vos plus fidèles soldats et partez en guerre. Cette expérience en
                    équipe de 4-5 joueurs vous propose de découvrir l'univers cartoonesque mais compétitif de notre
                    nouvelle room. Qu'attendez-vous soldat ?</p>
            </div>

            <!--BOUTON POUR RESERVER-->
            <div class="book_btn">
                <a href="../darkroom/dark_room1.html"><img class="image_black" src="../ressources/reserve.webp"
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <img src="../ressources/image128.webp" style="width:100%">
            <div class="text">
                <p class="txt_about_title_darkroom">NOUVELLE ROOM EN VUE !
                <p>
                <div class="about_txt_darkroom">En 2021, préparez à manger du slime en pleine face, les fantômes de
                    Ghost Buster arrivent chez THE SENSE. Ça promet de belles parties de chasse aux fantômes dans tout
                    le complexe. Les réservations sont d’ores et déjà possible sur place et en Février sur internet.
                </div>
            </div>
        </div>
