...
<!--==================1 EXPERIENCE==================-->
    ...
    <div class="img_exp">
        ...
        <img class="img_behind" src="../ressources/image 47sdffsdsfdsfdsdsdfsdfdsfdsdfhsdfhsdds.jpg" alt="image de l'experience"/><!--image du fond-->
        <!--NB DE LIKES-->
        <div class="likes">
...
<!--==================1 EXPERIENCE==================-->
    ...
    <div class="img_exp">
        ...
        <img class="img_behind" src="../ressources/image 64.png" alt="image de l'experience"/><!--image du fond-->
