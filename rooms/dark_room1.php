...
<body class="fond_dark_room">
    ...
    <header></header>
    <div class="loginbg">
        <form action="../account.php?method=login&redirect=rooms/dark_room2.php" method="POST" class="login-pan mb-3"
    ...
    <div class="intro_container_dark_room" id="intro">
        ...
        <div class="texte_intro_white">
            ...
            <div class="titre_intro_white">
                <p>QU'EST CE QUE LA <img src="../ressources/darkroom.webp" class="battle_room_logo" /><img
                        src="../ressources/darkroom.webp" class="battle_room_logo_mobile" /> ?</p>
            </div>

            <p> Vous pensez ne pas avoir peur du noir ? Que rien ne pourra vous effrayer ? Vous avez tord. Avec la DARK
                ROOM, toutes vos peurs deviendront réelles et en rien de temps, il ne
            ...
            <div class="red_texte">
                <p>*Les expériences proposées dans cette salle ne conviennent pas à un public mineur ou sensible.</p>
            </div>
    ...
    <div class="intro_exp_darkroom">
        ...
        <div class="img_exp">
            ...
            <img class="img_behind" src="../ressources/image_2.webp" alt="image de l'experience" />
            <!--image du fond-->
            <!--NB DE LIKES-->
            <div class="likes">
        ...
        <div class="about_exp_darkroom">
            ...
            <div class="about_title">
                ...
                <div class="break_line_darkroom"></div>
                <!--LIGNE SEPARATRICE-->
            ...
            <div class="about_txt_darkroom">
                <p>Revivez l'histoire d'un chef d'oeuvre cinématographique au travers d’une expérience aussi bien
                    réaliste qu'immersive. Rassemblez
        ...
        <div class="img_exp">
            ...
            <img class="img_behind" src="../ressources/image_58.webp" alt="image de l'experience" />
            <!--image du fond-->
        ...
        <div class="about_exp_darkroom">
            ...
            <!--TXT A PROPOS-->
            <div class="about_txt_darkroom">
                <p>De retour de soirée avec vos amis, votre voiture tombe soudainement en panne au beau milieu des bois.
                    Coïncidence, c’est dans cette forêt que l’on a signalé de mystérieuses disparitions. Après un long
                    moment à tenter d’appeller une dépanneuse, vous vous rendez compte que vous ne pouvez compter que
                    sur vous-même pour vous en sortir. Mais dans le froid de la nuit et les recoins de la forêt, quelque
                    chose rôde. Travaillez en équipe car sans vos amis, vous n’aurez aucune chance, survivrez-vous assez
                    longtemps ?</p>
            </div>

            <!--BOUTON POUR RESERVER-->
            <div class="book_btn">
                <a href="dark_room1.php"><img class="image_black" src="../ressources/Bouton réserver (Blanc).png"
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <div class="text">
                <div class="text_slideshowdown"><b>“Avec mes fils nous avons tenté l’expérience “NAMELESS”, moi qui
                        pensais avoir tout vu dans le domaine de l’horreur, je ne me suis jamais autant trompé.
