...
<body class="fond_template">
    ...
    <header></header>
    <div class="loginbg">
        <form action="../account.php?method=login&redirect=rooms/light_room1.php" method="POST" class="login-pan mb-3"
    ...
    <div class="intro_container" id="intro">
        ...
        <div class="texte_intro">
            ...
            <div class="titre_intro">
                <p>QU'EST CE QUE LA <img src="../ressources/LIGHT_ROOM_logo.png" class="battle_room_logo" /><img
    ...
    <div class="intro_exp">
        ...
        <div class="img_exp">
            ...
            <img class="img_behind" src="../ressources/image65.webp" alt="image de l'experience" />
            <!--image du fond-->
        ...
        <div class="about_exp_battleroom">
            ...
            <!--BOUTON POUR RESERVER-->
            <div class="book_btn">
                <a href="../rooms/light_room2.php"><img class="image_black" src="../ressources/reserve.webp"
    ...
    <div class="slideshow-container">
        ...
        <div class="mySlides fade">
            ...
            <div class="text">
                <p class="txt_about_title_darkroom">
                <p>
                <div class="text_slideshowdown"><b>“C’est dingue, j’ai vraiment eu l’impression d’être transporté dans
                        un autre monde. Avant je ne faisais pas d’expérience VR car je ne croyais pas en la qualité mais
                        grâce à The Sense, j’ai pu traverser la frontière du réel.”
